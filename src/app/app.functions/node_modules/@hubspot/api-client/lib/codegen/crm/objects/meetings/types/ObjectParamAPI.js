...
class ObjectAssociationsApi {
    ...
    archive(param, options) {
        return this.api.archive(param.meetingId, param.toObjectType, param.toObjectId, param.associationType, options).toPromise();
    }
    create(param, options) {
        return this.api.create(param.meetingId, param.toObjectType, param.toObjectId, param.associationType, options).toPromise();
    }
    getAll(param, options) {
        return this.api.getAll(param.meetingId, param.toObjectType, param.after, param.limit, options).toPromise();
    }
}
