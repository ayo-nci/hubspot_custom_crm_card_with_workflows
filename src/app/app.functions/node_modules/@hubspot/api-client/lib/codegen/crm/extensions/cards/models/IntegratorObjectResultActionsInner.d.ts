...
export declare type IntegratorObjectResultActionsInnerTypeEnum = "IFRAME";
export declare type IntegratorObjectResultActionsInnerHttpMethodEnum = "CONNECT" | "DELETE" | "GET" | "HEAD" | "OPTIONS" | "PATCH" | "POST" | "PUT" | "TRACE";
