...
exports.ObservableSearchApi = exports.ObservablePublicObjectApi = exports.ObservableBatchApi = exports.ObservableBasicApi = exports.ObservableAssociationsApi = void 0;
...
class ObservableAssociationsApi {
    ...
    archive(noteId, toObjectType, toObjectId, associationType, _options) {
        const requestContextPromise = this.requestFactory.archive(noteId, toObjectType, toObjectId, associationType, _options);
    ...
    create(noteId, toObjectType, toObjectId, associationType, _options) {
        const requestContextPromise = this.requestFactory.create(noteId, toObjectType, toObjectId, associationType, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getAll(noteId, toObjectType, after, limit, _options) {
        const requestContextPromise = this.requestFactory.getAll(noteId, toObjectType, after, limit, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
...
class ObservableBasicApi {
    ...
    archive(noteId, _options) {
        const requestContextPromise = this.requestFactory.archive(noteId, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getById(noteId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const requestContextPromise = this.requestFactory.getById(noteId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    update(noteId, simplePublicObjectInput, idProperty, _options) {
        const requestContextPromise = this.requestFactory.update(noteId, simplePublicObjectInput, idProperty, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
...
class ObservableBatchApi {
    ...
    read(batchReadInputSimplePublicObjectId, archived, _options) {
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)((rsp) => this.responseProcessor.read(rsp)));
        }));
    }
...
const PublicObjectApi_1 = require("../apis/PublicObjectApi");
class ObservablePublicObjectApi {
    constructor(configuration, requestFactory, responseProcessor) {
        this.configuration = configuration;
        this.requestFactory = requestFactory || new PublicObjectApi_1.PublicObjectApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new PublicObjectApi_1.PublicObjectApiResponseProcessor();
    }
    merge(publicMergeInput, _options) {
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)((rsp) => this.responseProcessor.merge(rsp)));
        }));
    }
}
exports.ObservablePublicObjectApi = ObservablePublicObjectApi;
