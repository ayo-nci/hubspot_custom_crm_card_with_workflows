...
exports.RedirectsApiResponseProcessor = exports.RedirectsApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class RedirectsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(urlRedirectId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (urlRedirectId === null || urlRedirectId === undefined) {
                throw new baseapi_1.RequiredError("RedirectsApi", "archive", "urlRedirectId");
            }
    ...
    getById(urlRedirectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (urlRedirectId === null || urlRedirectId === undefined) {
                throw new baseapi_1.RequiredError("RedirectsApi", "getById", "urlRedirectId");
            }
            const localVarPath = '/cms/v3/url-redirects/{urlRedirectId}'
                .replace('{' + 'urlRedirectId' + '}', encodeURIComponent(String(urlRedirectId)));
    ...
    getPage(createdAt, createdAfter, createdBefore, updatedAt, updatedAfter, updatedBefore, sort, properties, after, before, limit, archived, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            const localVarPath = '/cms/v3/url-redirects/';
    ...
    update(urlRedirectId, urlMapping, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (urlRedirectId === null || urlRedirectId === undefined) {
                throw new baseapi_1.RequiredError("RedirectsApi", "update", "urlRedirectId");
            }
            const localVarPath = '/cms/v3/url-redirects/{urlRedirectId}'
                .replace('{' + 'urlRedirectId' + '}', encodeURIComponent(String(urlRedirectId)));
...
class RedirectsApiResponseProcessor {
    archive(response) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getPage(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseWithTotalUrlMapping", "");
                return body;
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
...
//# sourceMappingURL=RedirectsApi.js.map