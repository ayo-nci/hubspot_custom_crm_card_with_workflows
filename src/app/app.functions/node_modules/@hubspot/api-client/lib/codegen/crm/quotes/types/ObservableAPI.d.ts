...
export declare class ObservableAssociationsApi {
    ...
    archive(quoteId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<void>;
    create(quoteId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations>;
...
export declare class ObservableBasicApi {
    ...
    archive(quoteId: string, _options?: Configuration): Observable<void>;
    ...
    update(quoteId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<SimplePublicObject>;
}
