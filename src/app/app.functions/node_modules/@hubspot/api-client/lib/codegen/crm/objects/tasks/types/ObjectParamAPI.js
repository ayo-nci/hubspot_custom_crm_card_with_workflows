...
class ObjectAssociationsApi {
    ...
    archive(param, options) {
        return this.api.archive(param.taskId, param.toObjectType, param.toObjectId, param.associationType, options).toPromise();
    }
    create(param, options) {
        return this.api.create(param.taskId, param.toObjectType, param.toObjectId, param.associationType, options).toPromise();
    }
    getAll(param, options) {
        return this.api.getAll(param.taskId, param.toObjectType, param.after, param.limit, options).toPromise();
    }
}
...
class ObjectBasicApi {
    ...
    archive(param, options) {
        return this.api.archive(param.taskId, options).toPromise();
    }
    create(param, options) {
    ...
    update(param, options) {
        return this.api.update(param.taskId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }
}
