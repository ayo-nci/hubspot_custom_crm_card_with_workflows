...
class DomainsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    getById(domainId, archived, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (domainId === null || domainId === undefined) {
                throw new baseapi_1.RequiredError("DomainsApi", "getById", "domainId");
            }
...
class DomainsApiResponseProcessor {
    getById(response) {
        return __awaiter(this, void 0, void 0, function* () {
