...
class ObservableAssociationsApi {
    ...
    archive(feedbackSubmissionId, toObjectType, toObjectId, associationType, _options) {
        const requestContextPromise = this.requestFactory.archive(feedbackSubmissionId, toObjectType, toObjectId, associationType, _options);
    ...
    create(feedbackSubmissionId, toObjectType, toObjectId, associationType, _options) {
        const requestContextPromise = this.requestFactory.create(feedbackSubmissionId, toObjectType, toObjectId, associationType, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getPage(feedbackSubmissionId, toObjectType, after, limit, _options) {
...
class ObservableBasicApi {
    ...
    archive(feedbackSubmissionId, _options) {
    ...
    update(feedbackSubmissionId, simplePublicObjectInput, idProperty, _options) {
