...
exports.PublicImportsApiResponseProcessor = exports.PublicImportsApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class PublicImportsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    getErrors(importId, after, limit, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (importId === null || importId === undefined) {
                throw new baseapi_1.RequiredError("PublicImportsApi", "getErrors", "importId");
            }
...
exports.PublicImportsApiRequestFactory = PublicImportsApiRequestFactory;
class PublicImportsApiResponseProcessor {
    getErrors(response) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.PublicImportsApiResponseProcessor = PublicImportsApiResponseProcessor;
//# sourceMappingURL=PublicImportsApi.js.map