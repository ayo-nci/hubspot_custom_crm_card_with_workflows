    ...
    doSearch(publicObjectSearchRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (publicObjectSearchRequest === null || publicObjectSearchRequest === undefined) {
                throw new baseapi_1.RequiredError("SearchApi", "doSearch", "publicObjectSearchRequest");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(publicObjectSearchRequest, "PublicObjectSearchRequest", ""), contentType);
    ...
    doSearch(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseWithTotalSimplePublicObjectForwardPaging", "");
                return body;
            }
