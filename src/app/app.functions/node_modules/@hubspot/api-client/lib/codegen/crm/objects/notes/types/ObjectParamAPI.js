...
class ObjectAssociationsApi {
    ...
    archive(param, options) {
        return this.api.archive(param.noteId, param.toObjectType, param.toObjectId, param.associationType, options).toPromise();
    }
    create(param, options) {
        return this.api.create(param.noteId, param.toObjectType, param.toObjectId, param.associationType, options).toPromise();
    }
