...
class ObservableAssociationsApi {
    ...
    archive(meetingId, toObjectType, toObjectId, associationType, _options) {
    ...
    create(meetingId, toObjectType, toObjectId, associationType, _options) {
    ...
    getAll(meetingId, toObjectType, after, limit, _options) {
...
class ObservableBasicApi {
    ...
    archive(meetingId, _options) {
        const requestContextPromise = this.requestFactory.archive(meetingId, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getById(meetingId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const requestContextPromise = this.requestFactory.getById(meetingId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    update(meetingId, simplePublicObjectInput, idProperty, _options) {
        const requestContextPromise = this.requestFactory.update(meetingId, simplePublicObjectInput, idProperty, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
