...
exports.ObservableSearchApi = exports.ObservablePublicObjectApi = exports.ObservableGDPRApi = exports.ObservableBatchApi = exports.ObservableBasicApi = exports.ObservableAssociationsApi = void 0;
...
class ObservableBasicApi {
    ...
    getById(contactId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const requestContextPromise = this.requestFactory.getById(contactId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    update(contactId, simplePublicObjectInput, idProperty, _options) {
        const requestContextPromise = this.requestFactory.update(contactId, simplePublicObjectInput, idProperty, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
