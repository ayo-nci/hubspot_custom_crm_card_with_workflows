...
class ObservableAssociationsApi {
    ...
    archive(quoteId, toObjectType, toObjectId, associationType, _options) {
        const requestContextPromise = this.requestFactory.archive(quoteId, toObjectType, toObjectId, associationType, _options);
    ...
    create(quoteId, toObjectType, toObjectId, associationType, _options) {
        const requestContextPromise = this.requestFactory.create(quoteId, toObjectType, toObjectId, associationType, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getAll(quoteId, toObjectType, after, limit, _options) {
        const requestContextPromise = this.requestFactory.getAll(quoteId, toObjectType, after, limit, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
