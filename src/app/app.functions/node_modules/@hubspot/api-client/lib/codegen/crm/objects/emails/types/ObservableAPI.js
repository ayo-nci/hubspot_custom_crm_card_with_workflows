...
class ObservableAssociationsApi {
    ...
    archive(emailId, toObjectType, toObjectId, associationType, _options) {
        const requestContextPromise = this.requestFactory.archive(emailId, toObjectType, toObjectId, associationType, _options);
    ...
    create(emailId, toObjectType, toObjectId, associationType, _options) {
        const requestContextPromise = this.requestFactory.create(emailId, toObjectType, toObjectId, associationType, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getAll(emailId, toObjectType, after, limit, _options) {
        const requestContextPromise = this.requestFactory.getAll(emailId, toObjectType, after, limit, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
...
class ObservableBasicApi {
    ...
    archive(emailId, _options) {
        const requestContextPromise = this.requestFactory.archive(emailId, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getById(emailId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const requestContextPromise = this.requestFactory.getById(emailId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    update(emailId, simplePublicObjectInput, idProperty, _options) {
        const requestContextPromise = this.requestFactory.update(emailId, simplePublicObjectInput, idProperty, _options);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
