...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(feedbackSubmissionId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (feedbackSubmissionId === null || feedbackSubmissionId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "feedbackSubmissionId");
            }
    ...
    getById(feedbackSubmissionId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (feedbackSubmissionId === null || feedbackSubmissionId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "feedbackSubmissionId");
            }
            const localVarPath = '/crm/v3/objects/feedback_submissions/{feedbackSubmissionId}'
                .replace('{' + 'feedbackSubmissionId' + '}', encodeURIComponent(String(feedbackSubmissionId)));
    ...
    update(feedbackSubmissionId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (feedbackSubmissionId === null || feedbackSubmissionId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "feedbackSubmissionId");
            }
            if (simplePublicObjectInput === null || simplePublicObjectInput === undefined) {
